...
namespace Homies.Tests
{
    ...
    internal class EventServiceTests
    {
        ...
        public async Task AddEventAsync_ShouldAddEvent_WhenValidEventModelAndUserId()
        {
            ...
            var eventInTheDatabase = _dbContext.Events.FirstOrDefault(x => x.Name == eventModel.Name && x.OrganiserId == userId);
        ...
        public async Task GetEventDetailsAsync_ShouldReturnAllEventDetails()
        {
            ...
            var eventInTheDb = _dbContext.Events.FirstAsync();
        ...
        [Test]
        public async Task GetEventForEditAsync_ShouldGetEvenetIfPresentInTheDatabase()
        {
            // Arrange
            var firstEventModel = new EventFormModel
            {
        ...
        [Test]
        public async Task GetEventOrganizerAddAsync_ShouldReturnOrganizerIdIfExisting()
        {
            // Arrange
            var firstEventModel = new EventFormModel
            {
        ...
        [Test]
        public async Task JoinEventAsync_ShouldReturnFalseIfUserIsAlredyPartIfTheEvent()
        {
            // Arrange
            const string userId = "userId";
        ...
        [Test]
        public async Task JoinEventAsync_ShouldReturnTrueIfTheUserIsAddedToEvent()
        {
            // Arrange
            const string userId = "userId";
        ...
        [Test]
        public async Task UpdateEventAsync_ShouldReturnTrue_IfWeUpdateTheEventSuccesfully()
        {
            // Arrange
            const string firstUserId = "first-user-id";
        ...
        [Test]
        public async Task GetAllTypeAsync_ShouldReturnAllTypes()
        {
            // Arrange
            var testType = new Data.Models.Type
            {
